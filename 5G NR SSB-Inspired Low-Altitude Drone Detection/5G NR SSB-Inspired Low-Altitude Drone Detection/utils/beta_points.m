function [beta_j_Pq, beta_SSB_echo,beta_j_Pq_fullloss] = beta_points(J,Q,point_positions,AP_positions,lambda) %ignore the constants lambda^2/(4*pi)^3
    ...
    beta_SSB_echo =  ones(1,5).*(min(min(beta_j_Pq))).*0.1 ;
