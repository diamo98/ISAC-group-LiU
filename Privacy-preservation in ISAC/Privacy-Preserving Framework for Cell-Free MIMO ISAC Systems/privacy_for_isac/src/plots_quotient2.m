...
folder = "C:\Users\henak56\research-data\privacy_cell_free_isac\old\data-new-new\";
%%% DE HÄR ÄR MED ALLT SLUMPAT (tror jag?)
% baseline
%f = "../new-precoder-mc-run1.mat";
%f = "data-new-new/b-quot-1.mat";
f = append(folder, "b-quot-1.mat");
